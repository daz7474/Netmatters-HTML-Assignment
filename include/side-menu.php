<div id="side-bar">
    ...
    <ul class="side-mobile-menu">
      ...
      <li class="nav-box">
        ...
        <div class="sub-item">
          <ul>
            <li>
              <a href="#">Bespoke Wesbite Design</a>
            </li>
    ...
    <ul class="side-sub-menu">
      ...
      <!-- Services -->
      <li class="list-item service-sub">
      ...
      <!-- Our Work -->
      <li class="list-item">
        <a class="heading" href="#">Our Work</a>
        <div class="sub-menu-service">
          <ul>
            <li>
              <a href="#">
            ...
            <li>
              <a href="#">
                <span class="icon-double_arrow"></span>
                <span>Our Digital Marketing Clients</span>
              </a>
            </li>
            <li>
              <a href="#">
                <span class="icon-double_arrow"></span>
                <span>Our Website Clients</span>
              </a>
            </li>
            <li>
              <a href="#">
            ...
            <li>
              <a href="#">
                <span class="icon-double_arrow"></span>
                <span>Our Bespoke Software Clients</span>
              </a>
            </li>
            <li>
              <a href="#">
                <span class="icon-double_arrow"></span>
                <span>Our Telecoms Clients</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <!-- Our Knowledge -->
      <li class="list-item">
        <a class="heading" href="#">Our Knowledge</a>
        <div class="sub-menu-service">
          <ul>
            <li>
              <a href="#">
      ...
      <!-- Training -->
      <li class="list-item">
        <a class="heading" href="#">Training</a>
        <div class="sub-menu-service">
          <ul>
            <li>
              <a href="#">
      ...
      <!-- Our Company -->
      <li class="list-item">
        <a class="heading" href="#">Our Company</a>
        <div class="sub-menu-service">
          <ul>
            <li>
              <a href="#">
      ...
      <li class="list-item">
        <a class="heading" href="#">Covid Risk Assessments</a>
      </li>
